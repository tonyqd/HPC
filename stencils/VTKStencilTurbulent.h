#ifndef _VTK_STENCIL_TURBULENT_H_
#define _VTK_STENCIL_TURBULENT_H_
 ...
 */
class VTKStencilTurbulent : public FieldStencil<FlowField> {
  
private:
  std::stringstream vstream;
  std::stringstream pstream;
  std::stringstream vistream;
    public:
         ...
         */
        VTKStencilTurbulent ( const Parameters & parameters );
