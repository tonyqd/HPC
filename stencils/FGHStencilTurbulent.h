#ifndef _STENCIL_FGH_TURBULENT_H_
#define _STENCIL_FGH_TURBULENT_H_

#include "../FlowField.h"
#include "../Stencil.h"
#include "../Parameters.h"

class FGHStencilTurbulent : public FieldStencil<FlowField>
{
    ...
    public:
        ...
        FGHStencilTurbulent ( const Parameters & parameters );
