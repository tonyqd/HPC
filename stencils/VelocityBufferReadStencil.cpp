...
void VelocityBufferReadStencil::applyLeftWall ( FlowField & flowField, int i, int j, int k) {
   ...
   */
	flowField.getVelocity().getVector(i-2, j, k)[0] = leftVelocityReadBuffer[0 + 6*((k)+((localSize[2]+3)*(j)))];
	flowField.getVelocity().getVector(i-2, j, k)[1] = leftVelocityReadBuffer[1 + 6*((k)+((localSize[2]+3)*(j)))];
	flowField.getVelocity().getVector(i-2, j, k)[2] = leftVelocityReadBuffer[2 + 6*((k)+((localSize[2]+3)*(j)))];
...
void VelocityBufferReadStencil::applyRightWall ( FlowField & flowField, int i, int j, int k) {
   ...
   */
	flowField.getVelocity().getVector(i+1, j, k)[0] = rightVelocityReadBuffer[0 + 3*((k)+((localSize[2]+3)*(j)))];
	flowField.getVelocity().getVector(i+1, j, k)[1] = rightVelocityReadBuffer[1 + 3*((k)+((localSize[2]+3)*(j)))];
	flowField.getVelocity().getVector(i+1, j, k)[2] = rightVelocityReadBuffer[2 + 3*((k)+((localSize[2]+3)*(j)))];
}
...
void VelocityBufferReadStencil::applyBottomWall ( FlowField & flowField, int i, int j, int k) {
   ...
   * from ParallelBoundaryIterater:  i = _lowOffset ; j = _lowOffset ; k = _lowOffset;
   */
	flowField.getVelocity().getVector(i, j-2, k)[0] = bottomVelocityReadBuffer[0 + 6*((k)+((localSize[2]+3)*(i)))];
	flowField.getVelocity().getVector(i, j-2, k)[1] = bottomVelocityReadBuffer[1 + 6*((k)+((localSize[2]+3)*(i)))];
	flowField.getVelocity().getVector(i, j-2, k)[2] = bottomVelocityReadBuffer[2 + 6*((k)+((localSize[2]+3)*(i)))];
...
void VelocityBufferReadStencil::applyTopWall ( FlowField & flowField, int i, int j, int k) {
   ...
   */
	flowField.getVelocity().getVector(i, j+1, k)[0] = topVelocityReadBuffer[0 + 3*((k)+((localSize[2]+3)*(i)))];
	flowField.getVelocity().getVector(i, j+1, k)[1] = topVelocityReadBuffer[1 + 3*((k)+((localSize[2]+3)*(i)))];
	flowField.getVelocity().getVector(i, j+1, k)[2] = topVelocityReadBuffer[2 + 3*((k)+((localSize[2]+3)*(i)))];
}
...
void VelocityBufferReadStencil::applyFrontWall ( FlowField & flowField, int i, int j, int k) {
   ...
   * from ParallelBoundaryIterater:  i = _lowOffset ; j = _lowOffset ; k = _lowOffset;
   */
	flowField.getVelocity().getVector(i, j, k-2)[0] = frontVelocityReadBuffer[0 + 6*((j)+((localSize[1]+3)*(i)))];
	flowField.getVelocity().getVector(i, j, k-2)[1] = frontVelocityReadBuffer[1 + 6*((j)+((localSize[1]+3)*(i)))];
	flowField.getVelocity().getVector(i, j, k-2)[2] = frontVelocityReadBuffer[2 + 6*((j)+((localSize[1]+3)*(i)))];
...
void VelocityBufferReadStencil::applyBackWall ( FlowField & flowField, int i, int j, int k) {
   ...
   */
	flowField.getVelocity().getVector(i, j, k+1)[0] = backVelocityReadBuffer[0 + 3*((j)+((localSize[1]+3)*(i)))];
	flowField.getVelocity().getVector(i, j, k+1)[1] = backVelocityReadBuffer[1 + 3*((j)+((localSize[1]+3)*(i)))];
	flowField.getVelocity().getVector(i, j, k+1)[2] = backVelocityReadBuffer[2 + 3*((j)+((localSize[1]+3)*(i)))];
}
